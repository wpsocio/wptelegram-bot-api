...
if ( ! class_exists( __NAMESPACE__ . '\Loader_1_2_5', false ) ) {
	/**
	...
	class Loader_1_2_5 {
		...
		/**
		 * Single instance of the Loader_1_2_5 object
		 *
		 * @var Loader_1_2_5
		 */
		...
		/**
		 * Creates/returns the single instance Loader_1_2_5 object
		 *
		 * @since  1.0.1
		 * @return Loader_1_2_5 Single instance object
		 */
